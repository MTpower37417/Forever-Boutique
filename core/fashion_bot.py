...
# from core.start_handler import start  # Commented out to prevent ModuleNotFoundError
# from core.menu_handler import fashion_menu  # Commented out to prevent ModuleNotFoundError
